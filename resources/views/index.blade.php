                                        ...
                                        <ul class="conversation-list slimscroll" style="max-height: 328px;">
                                            <li class="clearfix">
                                                <div class="chat-avatar">
                                                    <img src="{{ asset('assets/images/users/avatar-9.jpg') }}" alt="Female">
                                                    <i>10:00</i>
                                                </div>
                                            ...
                                            <li class="clearfix odd">
                                                <div class="chat-avatar">
                                                    <img src="{{ asset('assets/images/users/avatar-7.jpg') }}" alt="Male">
                                                    <i>10:01</i>
                                                </div>
                                                <div class="conversation-text">
                                                    <div class="ctext-wrap">
...
<!-- Mirrored from coderthemes.com/shreyu/preview/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Oct 2020 17:38:55 GMT -->
