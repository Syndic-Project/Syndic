...
@section('content')
                        ...
                        <div class="row mt-0">
                            ...
                            <div class="col-4">
                                <div class="d-flex justify-content-end">
                                    <button class="btn btn-outline-success" style="font-weight: bolder;"
                                            data-toggle="modal"
    ...
    <div id="modalAjoutLocataire" class="modal fade" tabindex="-1" role="dialog"
         aria-labelledby="modalAjoutLocataireLabel"
         aria-hidden="true">
