                            ...
                            <div class="row justify-content-start">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" required class="form-control"
                                            id="nomModif{{ $locataire->id }}" name="nomModif"
                                            value="{{ $locataire->nom }}" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" required class="form-control"
                                            id="prenomModif{{ $locataire->id }}" name="prenomModif"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" required class="form-control"
                                            id="cinModif{{ $locataire->id }}" name="cinModif"
                                            value="{{ $locataire->CIN }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" required class="form-control"
                                            id="emailModif{{ $locataire->id }}" name="emailModif"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" required class="form-control"
                                            id="telModif{{ $locataire->id }}" name="telModif"
                                            value="{{ $locataire->Tel }}" />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input style="font-style: oblique;" type="text" class="form-control"
                                            id="mdpModif{{ $locataire->id }}" name="mdpModif" value="************" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input style="font-style: oblique;" type="text" class="form-control"
                                            id="mdpConfirmModif{{ $locataire->id }}" name="mdpConfirmModif"
                                            value="************" />
                                    </div>
                                </div>
