                                        ...
                                        <td class="text-center">
                                            <a href="#modalModifLocataire{{ $locataire->id }}" data-toggle="modal"
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24"
                                                    height="24" data-toggle="tooltip" data-placement="top" title="Modifier"
                                            ...
                                            <a href="#modalSupprLocataire{{ $locataire->id }}" data-toggle="modal"
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24"
                                                    height="24" data-toggle="tooltip" data-placement="top" title="Supprimer"
                                                    viewBox="0 0 172 172" style=" fill:#000000;">
                                                    <g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1"
                                                        stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10"
                                                        stroke-dasharray="" stroke-dashoffset="0" font-family="none"
                                        ...
                                        {{-- <td class="text-center">
                                            @if ($locataire->email_verified_at != null)
                                                <img src="https://img.icons8.com/color/48/000000/verified-account.png"
                                                    style="width: 20px;cursor:pointer;" data-toggle="tooltip"
                                                    data-placement="top" title="Validé le 22/10/2020" />
                                                @else
                                                <img src="https://img.icons8.com/color/48/000000/cancel--v1.png"
                                                    style="width: 20px;cursor:pointer;" data-toggle="tooltip"
                                                    data-placement="top" title="non validé" />
                                            @endif
                                        </td> --}}
                                        <td class="text-center">{{ $locataire->Tel }}</td>
                                        <td class="text-center">
                                            {{ count($locataire->caisses->whereNotNull('Date_Paiment')->toArray()) }}
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
