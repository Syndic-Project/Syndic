                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" required="" name="designation" id="designation"
                                            class="form-control " value="{{ $facture->designation }}" />
                                    </div>

                                    <div class="form-group ">
                                        <label style="visibility: hidden ;margin-top: 14px"></label>
                                        <label class="labelFile2 p-2 text-capitalize form-control"
                                            style="height: fit-content;" for="inputFileid2" id="labelFile2"
                                            data-toggle="tooltip" data-placement="top" title="Fichier/piéce jointe">
                                            <i class="far fa-file-alt"></i>
                                            Reçu
                                        </label>
                                        <input class="inputFile form-control"
                                            onchange="AffectFichier('labelFile2',this.value)" type="file" name="preuve"
                                            id="inputFileid2" />
                                    </div>
