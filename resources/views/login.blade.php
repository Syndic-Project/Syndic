                        ...
                        <div class="card-body p-0">
                            <div class="row">
                                <div class="col-md-6 p-5">
                                    ...
                                    <form action="{{ route('Auth-Login-Post') }}" class="authentication-form"
                                        method="post">
                                        @csrf
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="email" class="form-control" id="email"
                                                    placeholder="email@domaine.com" name="emailInput"
                                                    value="test@Syndik.com" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mt-4">
                                            ...
                                            <a href="pages-recoverpw.html"
                                                class="float-right text-muted text-unline-dashed ml-1">Mot de passe
                                                oublié ?</a>
                                            <div class="input-group input-group-merge">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">
                                                ...
                                                <input type="password" class="form-control" id="password"
                                                    name="passwordInput" value="123*123" placeholder="Mot_De_Passe"
                                                    required>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-6 d-none d-md-inline-block">
                                    <div class="auth-page-sidebar">
                                        ...
                                        {{-- <div class="auth-user-testimonial">
                                            <p class="font-size-24 font-weight-bold text-white mb-1">un text overview
                                            </p>
