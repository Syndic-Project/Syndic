!function (r) {
    ...
    t.prototype.save = function () {
        var t = this.$chatInput.val(), e = moment().format("h:mm");
    ...
    t.prototype.initCharts = function () {
        ...
        var e = new Date, r = {
            ...
            colors: ["#43d39e"],
            xaxis: {
                type: "string", categories: function (t, e) {
                    for (var r = new Date(e, t, 1), a = [], o = 0; r.getMonth() === t && o < 15;) {
                        var n = new Date(r);
                        a.push(n.getDate() + " " + n.toLocaleString("en-us", {month: "short"})), r.setDate(r.getDate() + 1), o += 1
                    }
                    return a
                }(e.getMonth(), e.getFullYear()), tooltip: {enabled: !1}, axisBorder: {show: !1}, labels: {}
            },
            yaxis: {
                labels: {
                    formatter: function (t) {
